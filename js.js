	...
	switch(scene) {
	    ...
	    case 4:
	    	...
	    	if (int >= 17) {
	    		...
	    		document.getElementById("result").innerHTML = "Ouch, the merchant didnt budge and youre forced to buy it";
	    	}
	    	break;
	    case 5:
	    ...
	    case 9:
	    	...
	    	if (dex >= 14) {
	    		...
	    		document.getElementById("result").innerHTML = "Uh oh... A curse know plague your entire party";
	    	}
	    	break;
	    case 10:
